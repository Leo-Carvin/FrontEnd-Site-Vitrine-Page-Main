...
import HeroImg from "../../../../public/Image/standard-quality-control-collage-concept-_1_.webp";
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto w-full py-20 md:py-0">
            ...
            <div className="text-center md:text-left">
                ...
                >
                <span className="text-sm">Pourquoi CYNERIS ?</span>
                </motion.div>
                ...
                >
                Des avantages concrets pour votre{" "}
                <span className="text-[var(--color-1)]">entreprise</span>
                </motion.h1>
                ...
                >
                Sécurité renforcée, performance optimisée, coûts maîtrisés.
                Découvrez pourquoi plus de 200 entreprises font confiance à CYNERIS
                pour piloter leur infrastructure IT.
                </motion.p>
