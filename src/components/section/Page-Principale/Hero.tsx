...
export default function Hero() {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(to bottom right, var(--color-3) 0%, var(--color-4) 50%, var(--color-5) 100%)",
      }}
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-blue-100 mb-8 text-base md:text-lg">
              Expertise technique, sécurité renforcée et solutions sur mesure pour accompagner
