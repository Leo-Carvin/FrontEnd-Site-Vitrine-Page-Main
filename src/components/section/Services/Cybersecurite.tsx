...
import DataImg from "../../../../public/Image/thedigitalartist-cyber-4610993_1920.jpg";
    ...
    <section className="bg-white py-20 px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div className="flex flex-col gap-6">
          ...
          <Link href="/Page/DataScience" className="bg-[var(--color-4)] text-white font-bold px-8 py-4 rounded-lg w-fit hover:bg-opacity-90 transition">
            En savoir plus →
          </Link>
        </div>
