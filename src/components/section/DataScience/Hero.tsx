    ...
    <div className="max-w-7xl mx-auto w-full py-20 md:py-0">
        ...
        >
            ...
            >
                ...
                <span className="relative z-10 text-[var(--color-1)]"> avantage concurrentiel</span>
            </motion.h1>
            ...
            >
                Explorer vos lacs de données pour en extraire des connexions, des tendances
                et des signaux décisifs. CYNERIS place l'intelligence de vos données
                au cœur de vos enjeux métiers.
            </motion.p>
        ...
        >
            <Image src={HeroImg} alt="Data Science CYNERIS" priority className="rounded-xl shadow-2xl w-full max-w-sm md:max-w-full h-auto" />
        </motion.div>
