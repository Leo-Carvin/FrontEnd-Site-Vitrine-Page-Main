...
export default function Engagements() {
    return (
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
                Chez CYNERIS, chaque engagement est une promesse que nous tenons.
                Votre satisfaction et la continuité de votre activité sont nos priorités absolues.
            </motion.p>
            ...
            >
                {[
                "Disponibilité 24/7 et support réactif garanti",
                "Transparence totale sur les actions menées",
                "SLA personnalisés selon vos besoins",
                "Conseil stratégique et accompagnement sur le long terme",
                "Formations et sensibilisation de vos équipes",
                ].map((item, index) => (
                <motion.li
                    key={index}
                    variants={{
