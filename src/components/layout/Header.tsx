        ...
        <nav className="items-center hidden md:flex gap-6">
          <div className="relative group">
            ...
            <ul className="absolute left-0 top-full hidden group-hover:block bg-white shadow-lg rounded-lg py-2 w-56 border border-gray-200">
              ...
              <li><Link href="/Page/Cybersecurite" className="block px-4 py-2 hover:bg-accent hover:text-[var(--color-1)]">Cyber Sécurité</Link></li>
              <li><Link href="/Page/GestionDesDonnees" className="block px-4 py-2 hover:bg-accent hover:text-[var(--color-1)]">Gestion de données</Link></li>
              ...
              <li><Link href="/Page/SecureDev" className="block px-4 py-2 hover:bg-accent hover:text-[var(--color-1)]">Sécurité</Link></li>
            </ul>
          </div>
